...
//     aONFT = await MyONFT721.deploy(
//       "aONFT",
//       "aONFT",
//       mockEndpointA.address,
//       ownerA.address
//     );
//     bONFT = await MyONFT721.deploy(
//       "bONFT",
//       "bONFT",
...
//     await aONFT
//       .connect(ownerA)
//       .setPeer(eidB, hre.ethers.utils.hexZeroPad(bONFT.address, 32));
//     await bONFT
//       .connect(ownerB)
//       .setPeer(eidA, hre.ethers.utils.hexZeroPad(aONFT.address, 32));
//   });
...
//     await aONFT
//       .connect(ownerA)
//       .send(sendParam, [nativeFee, 0], ownerA.address, {value: nativeFee});
