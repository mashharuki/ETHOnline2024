...
//   }
//   const providerHolesky = hre.ethers.getDefaultProvider(
//     "https://1rpc.io/holesky"
//   );
//   const providerAmoy = hre.ethers.getDefaultProvider(
...
//     holeskyONFT = await hre.ethers.getContractAt(
//       "MyONFT721Mock",
//       holeskyONFTAddress,
//       walletOwnerA
//     );
//     amoyONFT = await hre.ethers.getContractAt(
//       "MyONFT721Mock",
//       amoyONFTAddress,
//       walletOwnerB
//     );
...
//     amoyEndpointB = await hre.ethers.getContractAt(
//       EndpointV2MockArtifact.abi,
//       amoyEndpointAddress,
//       walletOwnerB
//     );
...
//       .mint(walletOwnerA.address, tokenId, {
//         gasPrice: feeDataHolesky.gasPrice,
//       });
//     console.log("minted");

//     const beforeOwnerABalance = await holeskyONFT.balanceOf(
//       walletOwnerA.address
//     );
//     const beforeOwnerBBalance = await holeskyONFT.balanceOf(
//       walletOwnerB.address
//     );
...
//       .connect(walletOwnerA)
//       .send(sendParam, [nativeFee, 0], walletOwnerA.address, {
//         value: nativeFee,
//       });
